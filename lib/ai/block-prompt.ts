...
const SYSTEM = [
  ...
  "Editable fields by block type — text/heading/eyebrow: `text`; heading also `scale` ",
  "(display/h1/h2/h3/body/small); eyebrow also `accent` (none/line/bordered/numbered); ",
  "button: `label`, `href` (internal paths like /contact /about /events /sermons /giving), ",
  "`emphasis` (primary/secondary/outline); image: `treatment`, `aspect` — you may NOT set an ",
  "image source, photos are uploaded by the church; sermonCollection/eventCollection: ",
